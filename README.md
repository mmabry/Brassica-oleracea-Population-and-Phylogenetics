...
- [2. ADD READ GROUPS, SORT, MARK DUPLICATES, AND CREATE INDEX] ()
  - [A. Create read groups]()
  - [B. Mark duplicates]()
- [3. SPLIT'N'TRIM AND REASSIGN MAPPING QUALITIES]()
  - [A. Make index for GATK]()
  - [B. Run split and trim]()
- [4. VARIANT CALLING USING GVCF]()
  - [A. Call varients]()
  - [B. Combine samples to make a GVCF]()
  - [C. Make a data table]()
  - [D. Plot in R]()
...
- [8. PCAngsd]()
  - [A. sort and index using samtools]()
...
- [11. IQ-tree POMO]()
  ...
  - [C. Rename population headers]()
  - [D. Remove and remaining ? and replace with N]()
  - [E. Run Fasta to Counts script]()
  - [F. Run POMO]()
- [12. TreeMix ]()
  - [A. Make .clust file from .fam file]()
  - [B. Use the plink2treemix.py script from the authors of treemix to prepare plink data for treemix]()
  - [C. Run treemix]()
- [13. F-statistics]()
